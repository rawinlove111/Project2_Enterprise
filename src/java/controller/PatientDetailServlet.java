...
@WebServlet(name = "PatientDetailServlet", urlPatterns = {"/PatientDetail"})
public class PatientDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         RequestDispatcher rd = request.getRequestDispatcher("PatientDetail.jsp");
        try {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("S", da.getPatientById(id));
